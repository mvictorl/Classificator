...
<section class="container">
    ...
    <c:if test="${active_filial != null}">
        <a class="btn btn-primary pull-right" style="margin-bottom: 10px"  href="createDivision?active_filial=${active_filial}">Создать подразделение</a>
        <c:if test="${fn:length(divisions) > 0}">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-danger btn-xs" data-toggle="modal"
                                    ...
                                    data-id="${dvs.id}" data-name="${dvs.name}">Удалить
                            </button>
                        </td>
                    </tr>
                </c:forEach>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="#" type="button" class="btn btn-danger btn-lg">Да</a>
                            </div>
                        </div>
                    </div>
                </div><!-- Modal -->
