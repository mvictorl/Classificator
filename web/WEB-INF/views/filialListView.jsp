...
<section class="container">
    ...
    <a class="btn btn-primary pull-right" style="margin-bottom: 10px" href="createFilial">Создать филиал</a>
    <p>
                        ...
                        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a type="button" class="btn btn-info btn-lg" data-dismiss="modal">Нет</a>
                                        <a href="deleteFilial?id=${filial.id}" type="button" class="btn btn-danger btn-lg">Да</a>
                                    </div>
                                </div>
                            </div>
                        </div>
